...
export default function Slide() {
  ...
  return (
    <div className="h-screen pt-20 overflow-hidden bg-gray-100 bg-opacity-80">
      <div className="flex w-full">
        <div className="w-full h-screen relative">
          <img src={img1} alt="" className="absolute h-screen w-screen top-0 -z-10 opacity-50 object-cover" />
          <div className="w-screen mx-auto mt-40 px-5 flex flex-col items-center justify-center gap-4">
            <h1 className="font-bold text-gray-800 text-center text-5xl md:text-6xl tracking-widest">WELCOME</h1>
            <p className="mx-5 text-md text-center">Get original perfumes at affordable prices from the comfort of your home</p>
            <button className="text-white bg-orange-500 shadow p-2 rounded-md">SHOP NOW</button>
