  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative pb-16 border border-gray-500 p-2 shadow my-10 mx-2 sm:mx-auto max-w-[600px] rounded-md">
        ...
        <div className="flex items-center gap-8 border-b p-3">
          ...
          <div className="border rounded-sm py-1 border-gray-300 flex items-center justify-center px-5">
            <button
              disabled={counter == 1}
              onClick={() => {setSubTotal(subTotal / (counter)); setCounter(counter - 1)}}
            ...
            />
            <button
              onClick={() => {setSubTotal(subTotal * (counter + 1)); setCounter(counter + 1)}}
      ...
      <div className="my-10  ml-5">
        <h1 className="text-2xl text-gray-800 font-semibold tracking-wide border-b border-orange-300 w-[90%] pb-2">Summary</h1>
        <div className="space-y-5">
          <h1 className="mt-4 text-gray-700 font-semibold tracking-wide text-xl">Total Perfumes: 1</h1>
          <h1 className="mt-4 text-gray-700 font-semibold tracking-wide text-xl">Total Amount: NGN 13000</h1>
        </div>
      </div>
